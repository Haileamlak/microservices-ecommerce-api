...
const file_proto_user_proto_rawDesc = "" +
	...
	"\vVerifyToken\x12\x18.user.VerifyTokenRequest\x1a\x19.user.VerifyTokenResponseB$Z\"user-ms/internal/infrastructure/pbb\x06proto3"
...
var file_proto_user_proto_goTypes = []any{
	...
	(*VerifyTokenResponse)(nil), // 3: user.VerifyTokenResponse
}
var file_proto_user_proto_depIdxs = []int32{
	...
	3, // 3: user.UserService.VerifyToken:output_type -> user.VerifyTokenResponse
